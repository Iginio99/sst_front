diff --git a/c:\Users\Metrica\Documents\projects-exc\sst-backend/alembic/versions/20251217_01_init.py b/c:\Users\Metrica\Documents\projects-exc\sst-backend/alembic/versions/20251217_01_init.py
deleted file mode 100644
--- a/c:\Users\Metrica\Documents\projects-exc\sst-backend/alembic/versions/20251217_01_init.py
+++ /dev/null
@@ -1,304 +0,0 @@
...
-
-def seed_data() -> None:
-    # Nota: usamos SQL literal para máxima compatibilidad con Alembic/op.execute
-    # y para evitar el TypeError de "positional arguments".
-
-    # users
-    op.execute("""
-    INSERT INTO users (id, email, name, hashed_password)
-    VALUES (1, 'demo@sst.local', 'Demo User', 'demo')
